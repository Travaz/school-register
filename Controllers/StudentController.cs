...
namespace school_register.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FiscalCode,Name,Surname,Age,Birthday,FkClass,Email")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FiscalCode,Name,Surname,Age,Birthday,FkClass,Email")] Student student)
        {
            if (id != student.ID)
            {
                return NotFound();
